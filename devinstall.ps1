...
Write-Output "[1/5] Installing vbapm from local build artifacts..."

# Mirror packaged layout into %APPDATA%\vbapm (no zip extraction needed).
...
Write-Output "[2/5] Local artifacts copied."
